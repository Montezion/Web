...
const MONTE_ZION_CONFIG = {
  ...
  apariencia: {
    ...
    paletas: {
      ...
      SIERRA_ELEGIDO: {
        "--color-fondo-general": "#FFF8F2",
        "--color-fondo-secundario": "#F5E3CB",
        "--color-fondo-tarjeta": "#FFFFFF",
        "--color-header-bg": "linear-gradient(135deg, #b09066 0%, #f5e3cb 100%)",
        "--color-texto-principal": "#3E2723",
        "--color-texto-secundario": "#9b6c25",
        "--color-acento": "#892828",
        "--color-acento-hover": "#6e1e1e",
        "--color-boton-reserva-fondo": "#892828",
        "--color-boton-reserva-texto": "#FFFFFF",
        "--color-boton-reserva-glow": "rgba(137, 40, 40, 0.4)",
        "--color-borde": "rgba(137, 40, 40, 0.25)",
        "--color-separador-linea": "#892828",
        "--color-overlay-hero": "rgba(0, 0, 0, 0.4)",
        "--fuente-titulos": "'Lora', Georgia, serif",
        "--fuente-cuerpo": "'Montserrat', Arial, sans-serif"
      },
      SIERRA_TERRACOTA: {
        "--color-fondo-general": "#FAF3EB",
        "--color-fondo-secundario": "#EED8C3",
        "--color-fondo-tarjeta": "#FFFFFF",
        "--color-header-bg": "linear-gradient(135deg, #a37a54 0%, #e9d0b3 100%)",
        "--color-texto-principal": "#331e1a",
        "--color-texto-secundario": "#8a5a1e",
        "--color-acento": "#7a1f1f",
        "--color-acento-hover": "#5f1616",
        "--color-boton-reserva-fondo": "#7a1f1f",
        "--color-boton-reserva-texto": "#FFFFFF",
        "--color-boton-reserva-glow": "rgba(122, 31, 31, 0.4)",
        "--color-borde": "rgba(122, 31, 31, 0.25)",
        "--color-separador-linea": "#7a1f1f",
        "--color-overlay-hero": "rgba(0, 0, 0, 0.4)",
        "--fuente-titulos": "'Lora', Georgia, serif",
        "--fuente-cuerpo": "'Montserrat', Arial, sans-serif"
      },
      ...
      SIERRA_COBRE: {
        "--color-fondo-general": "#FCF6F0",
        "--color-fondo-secundario": "#EAD6C0",
        "--color-fondo-tarjeta": "#FFFFFF",
        "--color-header-bg": "linear-gradient(135deg, #9e7f56 0%, #eedcc4 100%)",
        "--color-texto-principal": "#2e1b17",
        "--color-texto-secundario": "#875e1b",
        "--color-acento": "#782226",
        "--color-acento-hover": "#5c181b",
        "--color-boton-reserva-fondo": "#782226",
        "--color-boton-reserva-texto": "#FFFFFF",
        "--color-boton-reserva-glow": "rgba(120, 34, 38, 0.4)",
        "--color-borde": "rgba(120, 34, 38, 0.25)",
        "--color-separador-linea": "#782226",
        "--color-overlay-hero": "rgba(0, 0, 0, 0.4)",
        "--fuente-titulos": "'Lora', Georgia, serif",
        "--fuente-cuerpo": "'Montserrat', Arial, sans-serif"
      }
