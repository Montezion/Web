...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (navEl) {
            ...
            if (burgerEl) burgerEl.addEventListener('click', () => navEl.classList.toggle('open'));
        }
        ...
        if (fab) {
            fab.href = `https://api.whatsapp.com/send?phone=${C.contacto.whatsapp_numero}&text=Hola%20Monte%20Zion!%20Consulto%20por%20${encodeURIComponent(apt.titulo_principal)}`;
            fab.target = '_blank';
